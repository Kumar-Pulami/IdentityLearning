...
namespace IdentityLearningAPI.Migrations
{
    ...
    [Migration("20230411041018_Added_IsDeleted_Property_to_assignable_table")]
    partial class Added_IsDeleted_Property_to_assignable_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityLearningAPI.Models.NewUserInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("InvitatedDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("IdentityLearningAPI.Models.UserToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IdentityLearningAPI.Models.MeetingRoomBooking", b =>
                {
                    ...
                    b.HasOne("IdentityLearningAPI.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IdentityLearningAPI.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
